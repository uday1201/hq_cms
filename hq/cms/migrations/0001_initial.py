    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('access_role', models.CharField(choices=[('MEMBER', 'Member'), ('ADMIN', 'Admin')], default='Member', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creator', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='excel_creator', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Exhibit',
            fields=[
                ...
                ('created_on', models.DateTimeField(blank=True, default=datetime.datetime.now)),
                ('creator', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='exhibit_creator', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Kt',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mentioned', models.ManyToManyField(blank=True, related_name='question_mentioned', to=settings.AUTH_USER_MODEL)),
                ('question', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='commentor', to='cms.question')),
            ],
        ),
        migrations.CreateModel(
            name='Assessment',
            fields=[
                ...
                ('assigned_to', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='assessment_assignedto', to=settings.AUTH_USER_MODEL)),
                ...
                ('qlist', models.ManyToManyField(blank=True, to='cms.question')),
                ('role', models.ManyToManyField(blank=True, to='cms.role')),
            ],
        ),
    ]
